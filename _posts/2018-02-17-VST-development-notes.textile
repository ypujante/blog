...
Testing with <code>validator</code> and deploying to a DAW are the same as the Xcode section with the difference that there is no <code>Debug</code> subfolders (if you use the default <code>Generation Path</code>, the <code>debug</code> is part of the directory name).
...
* It can then be deployed as described previously (copy/rename in the <code>~/Library/Audio/Plug-Ins/VST/</code>)

This post will be updated soon...

_Last edited: 2018/02/26_
